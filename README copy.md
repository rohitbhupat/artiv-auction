...
This project showcases how **technology can revolutionize art commerce and exhibitions**.
...
✅ Automated email notifications to highest bidder via **cron jobs**  
✅ Responsive, mobile-friendly design with **TailwindCSS** & **Bootstrap**  
✅ Built on **Django + PostgreSQL** with a scalable architecture  
...
- **Database:** PostgreSQL  
- **Hosting:** VPS (Hostinger Private Server)  
- **Real-Time Bidding & Notifications:** AJAX  
- **AR/VR Support:** WebXR, Three.js, AR.js  
- **360° Art View:** Meshy AI, `<model-viewer>`  
- **NLP Libraries:** spaCy, TextBlob  
- **Image Processing:** ImageHash (duplicate detection)  
- **Payments:** Razorpay  
- **Automation:** Cron jobs for email alerts  
...
## 🎥 Live Demo
[▶ Watch Live Demo](https://www.artiv.co.in/)  

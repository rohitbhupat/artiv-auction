...
class ArtworkAdmin(admin.ModelAdmin):
    ...
    list_display = ("product_name", "sale_type", "product_cat", "purchase_category", "opening_bid", "display_product_price", "is_sold")
    ...
    def display_product_price(self, obj):
        if obj.sale_type == "auction":
            return "-"
        return obj.product_price

    display_product_price.short_description = "PRODUCT PRICE"

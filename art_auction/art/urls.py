...
urlpatterns = [
   ...
   path('saleorder/confirm/<int:pk>',views.SaleOrderCreateView.as_view(),name="sale_order_confirm"),
   ...
   path('unsold_details/<int:pk>/',views.UnsoldArtworkDetailView.as_view(),name="unsold_details"),
